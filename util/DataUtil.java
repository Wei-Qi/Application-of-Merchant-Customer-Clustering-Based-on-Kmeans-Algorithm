...
public class DataUtil {
    public static final String HDFS_INPUT = "hdfs://192.168.142.128:9000/input"; // input地址
    public static final String HDFS_OUTPUT = "hdfs://192.168.142.128:9000/output/cluster3"; // output地址
